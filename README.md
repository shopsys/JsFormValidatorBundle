...
[![Build and tests](https://github.com/shopsys/JsFormValidatorBundle/actions/workflows/run-checks-tests.yml/badge.svg?event=status)](https://github.com/shopsys/JsFormValidatorBundle/actions/workflows/run-tests.yml)
